...
*[What’s out there?]
 P1-USH: Nothing you should worry about, but you shouldn’t be out in the forest. You should stay here where it’s safe.
~openDoor()
->2nd_part
...
P1-USH: Okay, but please don't go out into the forest!
 -> END
